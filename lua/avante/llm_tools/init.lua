...
You can delete the first file by providing a path of "directory1/a/something.txt"
  ...
  require("avante.llm_tools.get_enhanced_diagnostics"),
  require("avante.llm_tools.get_current_diagnostics"),
  require("avante.llm_tools.get_project_diagnostics_summary"),
